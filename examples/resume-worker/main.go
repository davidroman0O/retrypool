...
func main() {
	...
	pool = retrypool.NewPool(ctx, workers, retrypool.WithOnTaskSuccess(func(controller retrypool.WorkerController[int], workerID int, worker retrypool.Worker[int], task *retrypool.TaskWrapper[int]) {
